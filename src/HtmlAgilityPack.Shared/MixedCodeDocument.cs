...
public class MixedCodeDocument
{
    ...
    /// <param name="outStream">The stream to which you want to save.</param>
    /// <param name="encoding">The character encoding to use.</param>
    public static void Save(Stream outStream, Encoding encoding)
    {
...
#else
        StreamWriter sw = new(filename, false, GetOutEncoding());
#endif
        Save(sw);
    }
    ...
    /// <param name="filename">The location of the file where you want to save the document.</param>
    /// <param name="encoding">The character encoding to use.</param>
    public static void Save(string filename, Encoding encoding)
    {
#if NETSTANDARD1_3 || NETSTANDARD1_6
        StreamWriter sw = new StreamWriter(File.OpenWrite(filename), encoding);
#else
        StreamWriter sw = new(filename, false, encoding);
#endif
        Save(sw);
    }
