...
public sealed class HtmlEntity
{
    ...
    /// </summary>
    public static Dictionary<int, string> EntityName { get; private set; }

    /// <summary>
    /// A collection of entities indexed by value.
    /// </summary>
    public static Dictionary<string, int> EntityValue { get; private set; }
                            ...
                            else
                            {
                                if (entity[0] == '#')
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        _ = sb.Append(Convert.ToChar(code));
                                    }
                                    catch
                                    {
                                        _ = sb.Append("&#" + e + ";");
                                ...
                                _ = entity.Remove(0, entity.Length);
                            }
